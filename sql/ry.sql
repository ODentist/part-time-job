...
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COMMENT='代码生成业务表字段';
...
CREATE TABLE `job_apply_detail` (
  ...
  `user_id` int(11) NOT NULL COMMENT '求职者id（发送简历的userid）',
  `enterprise_id` int(11) NOT NULL COMMENT '企业id(职位的userid)',
  `position_id` int(11) NOT NULL COMMENT '职位id',
  `resume_id` int(11) NOT NULL COMMENT '简历id',
  `apply_time` datetime NOT NULL COMMENT '申请时间',
  PRIMARY KEY (`apply_id`),
  KEY `idx_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='职位申请记录';
...
CREATE TABLE `job_concern` (
  ...
  `user_id` int(11) NOT NULL COMMENT '企业人员id',
  `resume_id` int(11) NOT NULL COMMENT '简历id',
  `concern_time` datetime NOT NULL COMMENT '关注时间',
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`) USING BTREE,
  KEY `idx_resume_id` (`resume_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='企业关注表';
...
CREATE TABLE `job_enterprise` (
  ...
  `user_id` int(11) NOT NULL COMMENT '企业人员',
  `name` varchar(64) NOT NULL COMMENT '企业名称',
  `scale` tinyint(3) NOT NULL COMMENT '企业规模',
  `category` tinyint(3) NOT NULL COMMENT '企业性质',
  `address` varchar(64) NOT NULL COMMENT '企业地址',
  `phone` varchar(11) NOT NULL COMMENT '联系方式',
  `information` text COMMENT '企业信息',
...
-- ----------------------------
INSERT INTO `job_enterprise` VALUES ('2', '1', '名创优品（广州）有限责任公司', '5', '5', '总部-荔湾区康王中路486号和业广场18、19、25楼（全层） (邮编：510405)', '12345678900', null, '若依', '2020-02-10 14:15:44', null, null);
...
CREATE TABLE `job_invite` (
  ...
  `interview_place` varchar(100) DEFAULT NULL COMMENT '面试地点',
  `operate_status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '处理状态(0未处理，1已处理)',
  `operate_result` tinyint(3) DEFAULT NULL COMMENT '处理结果(0同意1拒绝)',
  `reason` varchar(255) DEFAULT NULL COMMENT '拒绝原因',
  `operate_time` datetime DEFAULT NULL COMMENT '处理时间',
  PRIMARY KEY (`invite_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='面试邀请';
...
CREATE TABLE `job_position` (
  ...
  `user_id` int(11) NOT NULL COMMENT '企业id',
  `position_name` varchar(20) NOT NULL COMMENT '职位名称',
  `position_type` tinyint(3) NOT NULL COMMENT '职位类型',
  `area` varchar(20) NOT NULL COMMENT '工作地点',
  `position_salary` tinyint(3) NOT NULL,
...
CREATE TABLE `job_receive_detail` (
  `receive_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '职位接收id',
  ...
  KEY `idx_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='职位接受记录';
...
CREATE TABLE `job_resume` (
  ...
  `resume_name` varchar(25) NOT NULL COMMENT '简历名称',
  `user_id` int(11) NOT NULL COMMENT '求职者id',
  `position_type` tinyint(3) NOT NULL COMMENT '职位类别',
  `content` varchar(500) NOT NULL COMMENT '简历内容',
  `area` varchar(20) NOT NULL COMMENT '地区',
  `salary` tinyint(3) NOT NULL COMMENT '薪资范围',
  `birthday` date NOT NULL COMMENT '生日',
  `phone` varchar(11) NOT NULL COMMENT '电话',
  `work_experience` varchar(500) DEFAULT NULL COMMENT '工作经历',
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '简历状态',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL,
  `file_name` varchar(200) DEFAULT NULL COMMENT '附件名称',
  `file_code` varchar(64) DEFAULT NULL COMMENT '附件编码',
...
CREATE TABLE `job_vip_detail` (
  ...
  `status` tinyint(3) NOT NULL DEFAULT '1' COMMENT '状态(1正常2停用)',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户开通vip记录';
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=639 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=264 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', '0', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2020-02-12 14:44:20', 'admin', '2018-03-16 11:33:00', 'ry', '2020-02-12 14:44:19', '管理员');
...
INSERT INTO `sys_user` VALUES ('3', '103', '0', 'qiye', 'qiye', '00', '111@qq.com', '15838772858', '0', '', '151a40eb7f763342c7a8823f4f5f58c1', 'bdff5e', '0', '0', '127.0.0.1', '2020-02-11 10:02:53', 'admin', '2020-02-05 12:47:04', '', '2020-02-11 10:02:53', null);
INSERT INTO `sys_user` VALUES ('4', '103', '1', 'qiuzhi', 'qiuzhi', '00', '1111@qq.com', '13012345678', '0', '', '788a097bfcd367bd86b872f43ad63a5b', '5bab55', '0', '0', '127.0.0.1', '2020-02-12 09:56:03', 'admin', '2020-02-06 09:51:08', 'qiuzhi', '2020-02-12 09:57:49', null);
...
INSERT INTO `sys_user` VALUES ('9', null, '0', 'youke', '游客', '00', '', '13212345674', '0', '', '27e05d167a2d0dd8cc1dbce18cc7bd2e', '1fcc7d', '0', '0', '127.0.0.1', '2020-02-06 17:15:04', 'youke', '2020-02-06 15:28:34', '', '2020-02-06 17:15:04', null);
...
INSERT INTO `sys_user` VALUES ('11', null, '0', 'youke11', '游客11', '00', '', '13212345676', '0', '', 'd85ac05221bd7e1c5d45026d93029c15', '167f79', '0', '0', '127.0.0.1', '2020-02-06 18:23:58', 'youke11', '2020-02-06 15:33:17', '', '2020-02-06 18:23:58', null);
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('4b52b611-cca2-4330-9afe-edc2eec1b8b4', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2020-02-12 14:44:16', '2020-02-12 14:44:20', '1800000');
INSERT INTO `sys_user_online` VALUES ('7306ef9c-5b92-4b5f-b088-a83c374833bf', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Microsoft Edge', 'Windows 10', 'on_line', '2020-02-12 14:28:32', '2020-02-12 14:28:35', '1800000');
...
-- ----------------------------
-- Table structure for weixin_order
-- ----------------------------
DROP TABLE IF EXISTS `weixin_order`;
CREATE TABLE `weixin_order` (
  `order_no` varchar(32) NOT NULL COMMENT '订单号',
  `user_id` int(11) NOT NULL COMMENT '用户id',
  `amount` int(11) DEFAULT NULL COMMENT '金额(单位分)',
  `status` varchar(10) DEFAULT NULL COMMENT '支付状态',
  `pay_time` datetime DEFAULT NULL COMMENT '支付时间',
  `describe_info` varchar(100) DEFAULT NULL COMMENT '商品描述',
  PRIMARY KEY (`order_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='微信支付订单';

-- ----------------------------
-- Records of weixin_order
-- ----------------------------
INSERT INTO `weixin_order` VALUES ('2020021209022753823', '4', '10', 'SUCCESS', null, '30天(10元)');
INSERT INTO `weixin_order` VALUES ('2020021209022768254', '4', '10', 'SUCCESS', null, '30天(10元)');
INSERT INTO `weixin_order` VALUES ('2020021209023472341', '4', '10', 'SUCCESS', null, '30天(10元)');
INSERT INTO `weixin_order` VALUES ('2020021209023819203', '4', '10', 'SUCCESS', null, '30天(10元)');
