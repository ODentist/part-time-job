package com.parttime.project.job.invite.mapper;
 ...
 * @date 2020-02-10
 */
public interface JobInviteMapper 
{
    /**
     * 查询面试邀请
     * 
    ...
    public InviteVO selectJobInvite(@Param("inviteId") Long inviteId);
     ...
     * @return 结果
     */
    public int deleteJobInviteByIds(String[] inviteIds);
}
